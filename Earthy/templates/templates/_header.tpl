...
{* http://gnu.org                                                          *}
{***************************************************************************}
{* $Id:: _header.tpl 2092 2008-12-05 19:23:35Z WanWizard                  $*}
{*-------------------------------------------------------------------------*}
...
<head>
	...
	<script type='text/javascript' src='{$smarty.const.INCLUDES}jscripts/core_functions__0001.js?version=1'></script>
...
<div id="wrapper">
	...
	<div id="borderr">
		<div id="borderl">
			...
			<div id="midheader">
				<div id="midheader_maint" style="color:{$settings.maintenance_color}">
					{if $settings.maintenance}
						MAINTENANCE
					{/if}
				</div>
				<div id="midheader_title">
					Earthy Theme
				</div>
			</div>
			<div id="botheader">
				<div id="botheader_date">
					{$smarty.now|date_format:"subheaderdate"}
				</div>
				<div id="botheader_icons">
